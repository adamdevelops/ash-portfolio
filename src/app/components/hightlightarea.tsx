...
export default function HighlightArea({projArea, media, title, description}: {projArea: boolean, media: string, title: string, description: string}) {
    ...
    const areaDiv = (projArea: boolean) =>  {
        if(projArea){
            ...
            return(
                <div className="highlight-area flex flex-row justify-center mb-10">
                    <div className="media">
                        <video autoPlay loop muted className="rounded-md w-full max-w-xl" src={media} width={300} height={300} />
                    </div>
